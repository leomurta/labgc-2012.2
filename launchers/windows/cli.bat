...
set LABCG_OUT="java -cp %LABCG_PATH% -Dbr.uff.ic.labgc.invocation=%~sdp0 -Djava.rmi.server.codebase=file:\%LABCG_RMI_CODEBASE% -Djava.rmi.server.hostname=%LABCG_RMI_HOSTNAME% -Djava.security.policy=%LABCG_POLICITY% br.uff.ic.labgc.AppCLI %*"
echo %LABCG_OUT%
