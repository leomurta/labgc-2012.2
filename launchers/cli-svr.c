/**
 * Programa utilizado para gerar os launchers do linux e windows, cliente e servidor
 *
 * @author Felipe R
 * 
 * Como compilar:
 * 
 * SERVER
 * gcc -D SERVER -o server cli-svr.c            Linux 
 * gcc -D SERVER -o server.exe cli-svr.c        Windows
 * 
 * CLIENT
 * gcc -o cli cli-svr.c         Linux
 * gcc -o cli.exe cli-svr.c     Windows  
 * 
 */
