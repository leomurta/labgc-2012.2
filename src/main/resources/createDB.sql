...
CREATE SEQUENCE LABGC.SEQ_USER;ALTER TABLE labgc.SEQ_USER OWNER TO labgc;
CREATE SEQUENCE LABGC.SEQ_REVISION;ALTER TABLE labgc.SEQ_REVISION OWNER TO labgc;
CREATE SEQUENCE LABGC.SEQ_PROJECT;ALTER TABLE labgc.SEQ_PROJECT OWNER TO labgc;
CREATE SEQUENCE LABGC.SEQ_CONFIGITEM;ALTER TABLE labgc.SEQ_CONFIGITEM OWNER TO labgc;
